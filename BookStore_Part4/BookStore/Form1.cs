...
namespace BookStore
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand com = new SqlCommand("Update Book Set BookName = @0, AuthorName = @1 where BookId = @2",con);
            com.Parameters.AddWithValue("0", BookName);
            com.Parameters.AddWithValue("1", AuthorName);
            com.Parameters.AddWithValue("2", BookId);
        ...
        private void textBox3_TextChanged(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(Properties.Settings.Default.connectionString);
            con.Open();
            SqlCommand com = new SqlCommand("Select * from Book where BookName Like @0 or AuthorName Like @0", con);
            com.Parameters.AddWithValue("0", search);
